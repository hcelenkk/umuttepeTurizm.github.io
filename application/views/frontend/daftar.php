						...
						<div class="card ">
							...
							<div class="card-body">
								<form action="<?php echo base_url() ?>login/daftar" method="post">
									<div class="form-group">
										<div class="form-group">
											<div class="form-label-group">
												<input type="text" name="name" class="form-control" required="" placeholder="Adınız Soyadınız" value="<?php echo set_value('name') ?>">
									...
									<div class="form-group">
										<div class="form-row">
											...
											<div class="col-md-6">
												<div class="form-label-group">
													<input type="number" id="nomor" name="nomor" class="form-control" required="" placeholder="Telefon Numarası" value="<?php echo set_value('nomor') ?>">
									...
									<div class="form-group">
										...
										<div class="form-label-group">
											<textarea class="form-control" name="alamat"><?php echo set_value('adres') ?></textarea>
											<?php echo form_error('adres'),'<p class="text-danger pl-3">','</p>'; ?>
										</div>
									</div>
									<div class="form-group">
										<div class="form-label-group">
											<input type="text" id="username" name="username" class="form-control" required="" placeholder="Kullanıcı Adı" >
											<?php echo form_error('kullaniciAdi'),'<small class="text-danger pl-3">','</small>'; ?>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-6">
											<input type="password" class="form-control form-control-user" name="password2" placeholder="Şifre (Tekrar)">
										</div>
									</div>
								...
								<div class="text-center">
									<p>Zaten Kayıtlı Mısınız? <a class="" href="<?php echo base_url() ?>login">Giriş Yapın</a></p>
								</div>
							</div>
						</div>
					</div>
