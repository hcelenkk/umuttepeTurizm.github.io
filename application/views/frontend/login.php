...
<html lang="zxx" class="no-js">
	<head>
		...
		<!-- Site Title -->
		<title>Otobüs Bilet Rezervasyonu</title>
				...
				<div class="row height align-items-center justify-content-center">
					<div class="col-lg-5">
						<div class="card card-login mx-auto mt-10">
							<div class="card-header">Müşteri Kayıt Paneli</div>
							<div class="card-body" align="left">
								...
								<div class="text-center">
									<p><a class="d-block mt-3" href="<?php echo base_url() ?>login/daftar">Kayıt Ol</a>
									<hr>
