							...
							<div class="card mb-5">
								...
								<div class="card-body">
									<div class='form-group'>
										...
										<div class='form-group'>
											<div class='col-sm-12'>
												<input name='nama_pemesan' required="" maxlength='64' class='form-control required' placeholder='Customer Name' type='text' title='Customer name is required' value="<?php echo $this->session->userdata(musteriAdi) ?>"></div>
											</div>
											<div class='form-group'>
												<div class='col-sm-12'>
													<input name='hp' required="" maxlength='16' class='form-control required' placeholder='Handphone' type='text' title='Required Field' value="<?php echo $this->session->userdata('telefon') ?>"></div>
												</div>
												<div class='form-group'>
													<div class='col-sm-12'>
													<textarea name='adres' cols='20' rows='3' id='adres' required="" maxlength='256' class='form-control required' placeholder='Address' title='Address Required.' ><?php echo $this->session->userdata('adres')?></textarea></div>
												</div>
												<div class='form-group'>
													<div class='col-sm-12'>
													...
													<form action="<?php echo base_url() ?>tiket/cektiketmu" method="post">
														<div class="form-group">
															...
															<select class="form-control" name="bank" required>
																...
																<option value="<?php echo $row['bankaKodu'] ?>"><?php echo $row['bankaAdi']; ?></option>
																<?php } ?>
															</select>
														</div>
														<hr>
