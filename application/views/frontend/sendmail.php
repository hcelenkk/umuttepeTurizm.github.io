			...
			<tr>
				<td colspan="2">
					<p style="text-align: justify; padding: 10px;">
						Sayın Yolcumuz,<br>
						Umuttepe Turizm'i tercih ettiğiniz için teşekkürler.
					</p>
					<p style="text-align: justify; padding: 10px;">
					Here's a Summary of Your Purchases:
						<table width="100%" style="font-size: 14px; margin: 10px;">
								...
								Account Number Transfer Manual
									...
									<td>
										<strong><?= $sendmail['bankaHesapNo']; ?></strong>
									</td>
								</tr>
								<tr>
								<td>
								On behalf of
									...
									<td>
										<strong><?= $sendmail['bankaMusteri']; ?></strong>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>:</td>
									<td>
										<strong><?= $sendmail['bankaAdi']; ?></strong>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>:</td>
									<td>
										<?php $total = $count * $sendmail['fiyatTarifesi'] ?>
								...
								<tr>
									...
									<td>:</td>
									<td>
										<strong><?= $sendmail['rezervasyonKodu']; ?></strong>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>:</td>
									<td>
										<strong>Schedule Code <?= $sendmail['saatKodu'] ?></strong><br>
										<strong>Depart <?= hari_indo(date('N',strtotime($sendmail['rezervasyonYapilanTarih']))).', '.tanggal_indo(date('Y-m-d',strtotime(''.$sendmail['rezervasyonYapilanTarih'].''))).', '.date('H:i',strtotime($sendmail['kalkisSaati'])); ?></strong><br>
								...
								<tr>
									...
									<td>:</td>
									<td>
										<strong><?= $sendmail['rezervasyonTarihi']; ?></strong>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>:</td>
									<td>
										<strong><?php $expired = hari_indo(date('N',strtotime($sendmail['rezervasyonSonGecerlilik']))).', '.tanggal_indo(date('Y-m-d',strtotime(''.$sendmail['rezervasyonSonGecerlilik'].''))).', '.date('H:i',strtotime($sendmail['rezervasyonSonGecerlilik'])); echo $expired;?></strong>
									</td>
								</tr>
									</table>
								</p>
													...
													<div class="col-md-4">
														<div style="border:1px solid #fd7521;margin:2px;padding:5px;">
															...
															<ol style="padding:0;">
																...
																<li>Select <span class="label">To account <?= $sendmail['bankaAdi'];; ?> </span></li>
																<li>Enter Account Number <span class="label"><?= $sendmail['bankaHesapNo']; ?></span></li>
