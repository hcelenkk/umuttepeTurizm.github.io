...
<tbody>
    ...
    <tr>
        <td style="text-align:center;"><?php echo $row['biletKodu'];?></td>
        <td style="padding-left:5px;"><?php echo $row['rezervasyonKodu'];?></td>
        <td style="text-align:center;"><?php echo $row['biletAdi'];?></td>
        <td style="text-align:center;"><?php echo $row['biletYas'];?></td>
        <td style="text-align:center;"><?php echo $row['biletKoltuk'];?></td>
        <td style="text-align:left;"><?php echo '$'.number_format($row['biletFiyat']);?></td>
    </tr>
    <?php } ?>
</tbody>
<tfoot>
...
<table align="center" style="width:800px; border:none;margin-top:5px;margin-bottom:20px;">
    ...
    <tr>
        <td align="right">( <?php echo $this->session->userdata('adminKullaniciAdi');?> )</td>
    </tr>
    <tr>
        <td align="center"></td>
    </tr>
