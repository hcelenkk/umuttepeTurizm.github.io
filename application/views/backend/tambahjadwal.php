                ...
                <form action="<?= base_url()?>backend/jadwal/tambahjadwal" method="post">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="asal" required>
                      ...
                      <option value="<?= $row['sehirKodu'] ?>" ><?= strtoupper($row['hedefSehir'])." - ".$row['terminalSehri']; ?></option>
                      <?php } ?>
                    </select>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="bus">
                      ...
                      <option value="<?= $row['otobusKodu'] ?>" ><?= strtoupper($row['otobusAdi']); ?> -<?php if ($row['otobusDurumu'] == '1') { ?>
                        Active
                        <?php } else { ?>
                        InActive
                      <?php } ?>- </option>
